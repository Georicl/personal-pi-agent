...
| `publish` | `scope`, `documentId`, `userConfirmed`, `expectedContentHash` | Publish only the exact previewed draft version; verify both indexed and current-file hashes before moving into reviewed cards |
